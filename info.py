...
PICS = (environ.get('PICS', 'https://envs.sh/BoN.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://trmoviehq:ccYqXcJ9gzM6LY4c@trautofilter.fnq3hcu.mongodb.net/?retryWrites=true&w=majority&appName=TRAutoFilter")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "vjclonefilterbot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Jhi4LE0JK3AyZDA1')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TR_contact_bot')
